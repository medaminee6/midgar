...
class Personnage
{
    ...
    #[ORM\Column(name: 'classRole', type: 'string', length: 100)]
    #[Assert\NotBlank(message: "La classe est obligatoire.")]
    private ?string $classRole = null;

    #[ORM\Column(name: 'historyContext', type: 'text')]
    ...
    #[ORM\Column(name: 'abilitiesPowers', type: 'text', nullable: true)]
    ...
    #[ORM\Column(name: 'portraitImage', type: 'blob', nullable: true)]
