...
final class Version20260211000000 extends AbstractMigration
{
    ...
    {
        // Create oeuvre table
        $this->addSql('CREATE TABLE oeuvre (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, type VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, date_pub DATE DEFAULT NULL, image_url VARCHAR(500) DEFAULT NULL, author VARCHAR(255) DEFAULT NULL, created_by_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_30A25A6412469DE2 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE artefact (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(50) NOT NULL, universe VARCHAR(255) NOT NULL, origins LONGTEXT NOT NULL, powers LONGTEXT NOT NULL, rarity VARCHAR(50) NOT NULL, image_url VARCHAR(500) DEFAULT NULL, created_by_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_8B4AA47B12469DE2 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
